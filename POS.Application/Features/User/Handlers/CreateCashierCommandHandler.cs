...
{
    public class CreateCashierCommandHandler : IRequestHandler<
        ...
        UserResponseDTO>
    {
        ...
        public CreateCashierCommandHandler(IUserRepository userRepository, IPasswordHasher passwordHasher, IMapper mapper)
        {
            _userRepository = userRepository;
            _passwordHasher = passwordHasher;
            _mapper = mapper;
        }
        public async Task<UserResponseDTO> Handle(CreateCashierCommand request, CancellationToken cancellationToken)
        {
            UserEntity userEntity = _mapper.Map<UserEntity>(request.Cashier);
            ...
            // set role to cashier
            userEntity.Role = UserRole.Cashier;
